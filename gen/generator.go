...
const pkgEasyPHPSerialize = "github.com/golyakov/easyphpserialize"
...
func NewGenerator(filename string) *Generator {
	ret := &Generator{
		imports: map[string]string{
			pkgWriter:           "pwriter",
			pkgLexer:            "plexer",
			pkgEasyPHPSerialize: "easyphpserialize",
			"encoding/json":     "json",
		},
...
// NoStdMarshalers instructs not to generate standard MarshalPhpSerialize/UnmarshalPhpSerialize
...
func (g *Generator) printHeader() {
	...
	fmt.Println("// Code generated by easyphpserialize for marshaling/unmarshaling. DO NOT EDIT.")
	fmt.Println()
	...
	fmt.Println("   _ *plexer.Lexer")
	fmt.Println("   _ *pwriter.Writer")
	fmt.Println("   _ easyphpserialize.Marshaler")
	fmt.Println(")")
...
func (g *Generator) functionName(prefix string, t reflect.Type) string {
	prefix = joinFunctionNameParts(true, "easyphpserialize", g.hashString, prefix)
...
func (DefaultFieldNamer) GetJSONFieldName(t reflect.Type, f reflect.StructField) string {
	jsonName := strings.Split(f.Tag.Get("php"), ",")[0]
	if jsonName != "" {
		return jsonName
	}
