...
func TestString(t *testing.T) {
	for i, test := range []struct {
		...
		{toParse: `s:13:"simple string"`, want: "simple string"},
		{toParse: " \r\r\n\t  " + `"test"`, want: "test"},
		{toParse: `"\n\t\"\/\\\f\r"`, want: "\n\t\"/\\\f\r"},
		{toParse: `"\u0020"`, want: " "},
		{toParse: `"\u0020-\t"`, want: " -\t"},
...
func TestNumber(t *testing.T) {
	for i, test := range []struct {
		...
		{toParse: "i:123", want: "123"},
		{toParse: "i:-123", want: "-123"},
		{toParse: "d:12.35", want: "12.35"},
		// {toParse: "\r\n12.35", want: "12.35"},
...
func TestBool(t *testing.T) {
	for i, test := range []struct {
		...
		{toParse: "b:1", want: true},
		{toParse: "b:0", want: false},
...
func TestInterface(t *testing.T) {
	for i, test := range []struct {
		...
		{toParse: "N", want: nil},
		{toParse: "b:1", want: true},
		{toParse: `s:1:"a"`, want: "a"},
		{toParse: "d:5", want: float64(5)},

		{toParse: `O:8:"stdClass":0:{}`, want: map[string]interface{}{}},
		{toParse: `a:0:{}`, want: []interface{}{}},

		{toParse: `a:1:{s:1:"a";s:1:"b";}`, want: map[string]interface{}{"a": "b"}},
		{toParse: `a:1:{i:0;i:5;}`, want: []interface{}{float64(5)}},
		{toParse: `a:1:{i:0;b:1;}`, want: []interface{}{true}},

		{toParse: `a:2:{s:1:"a";i:5;s:1:"b";s:6:"string";}`, want: map[string]interface{}{"a": float64(5), "b": "string"}},
		{toParse: `a:4:{i:0;s:1:"a";i:1;i:5;i:2;N;i:3;b:1;}`, want: []interface{}{"a", float64(5), nil, true}},
		{toParse: `O:1:"B":2:{s:1:"a";O:1:"A":1:{s:1:"a";s:1:"a";}s:1:"c";i:1;}`, want: map[string]interface{}{"a": map[string]interface{}{"a": "a"}, "c": float64(1)}},
		{toParse: `a:2:{i:0;O:1:"A":1:{s:1:"a";s:1:"a";}i:1;O:1:"A":1:{s:1:"a";s:2:"aa";}}`, want: []interface{}{map[string]interface{}{"a": "a"}, map[string]interface{}{"a": "aa"}}},
...
var strData = []byte(`s:13:"simple string"`)

func BenchmarkAll(b *testing.B) {
	for i := 0; i < b.N; i++ {
		l := Lexer{Data: strData}
		_ = l.String()
