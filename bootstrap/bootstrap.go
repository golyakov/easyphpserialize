...
const genPackage = "github.com/golyakov/easyphpserialize/gen"
const pkgWriter = "github.com/golyakov/easyphpserialize/pwriter"
const pkgLexer = "github.com/golyakov/easyphpserialize/plexer"
...
func (g *Generator) writeStub() error {
	...
	fmt.Fprintln(f, "// TEMPORARY AUTOGENERATED FILE: easyphpserialize stub code to make the package")
	...
	for _, t := range g.Types {
		...
		if !g.NoStdMarshalers {
			fmt.Fprintln(f, "func (", t, ") MarshalPhpSerialize() ([]byte, error) { return nil, nil }")
			fmt.Fprintln(f, "func (*", t, ") UnmarshalPhpSerialize([]byte) error { return nil }")
		}

		fmt.Fprintln(f, "func (", t, ") MarshalEasyPhpSerialize(w *pwriter.Writer) {}")
		fmt.Fprintln(f, "func (*", t, ") UnmarshalEasyPhpSerialize(l *plexer.Lexer) {}")
		fmt.Fprintln(f)
		fmt.Fprintln(f, "type EasyPhpSerialize_exporter_"+t+" *"+t)
	}
	return nil
}
...
func (g *Generator) writeMain() (path string, err error) {
	f, err := ioutil.TempFile(filepath.Dir(g.OutName), "easyphpserialize-bootstrap")
	if err != nil {
		return "", err
	}
	...
	fmt.Fprintln(f)
	fmt.Fprintln(f, "// TEMPORARY AUTOGENERATED FILE: easyphpserialize bootstapping code to launch")
	...
	for _, v := range g.Types {
		fmt.Fprintln(f, "  g.Add(pkg.EasyPhpSerialize_exporter_"+v+"(nil))")
	}
